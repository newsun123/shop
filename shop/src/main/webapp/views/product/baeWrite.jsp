...
<div id="top"> 주소 설정</div>
	...
	<div class="text"> <!-- 우편번호칸 -->
		<input type="text" name="zip" placeholder="우편번호" onclick="juso_search()">
	</div>
	<div class="text"> <!-- 주소 -->
		<input type="text" name="juso" placeholder="주소">
	</div>
	<div class="text"> <!-- 상세주소 -->
		<input type="text" name="jusoEct" placeholder="상세주소">
	</div>
	<div class="text"> <!-- 요청사항 -->
		<select name="req">
	...
	<div class="text"> <input type="checkbox" name="gibon" value="1"> 기본 배송지로 사용 </div>
	<div class="text"> <input type="submit" value="저장하기"> </div>
</form>
</body>
</html>